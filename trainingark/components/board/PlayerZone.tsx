...
export function cleanDecklistLine(rawLine: string): string {
	...
	// Strip set code and everything after — the \s+ before ( prevents false
	// matches on card names that might contain parentheses
		...
		try {
			...
			const card: Card = {
				...
				imageUrl: cardData.image_uris?.normal ?? (() => {
					...
					// For DFC tokens (e.g. Dinosaur // Treasure), pick the face whose name
					// matches what the user searched for, not always index 0
